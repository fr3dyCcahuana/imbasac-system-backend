...
public class ProformaMapper {
    ...
    public static ProformaV2Response toResponse(Proforma p, List<ProformaItem> items) {
        return ProformaV2Response.builder()
                ...
                .taxStatus(p.getTaxStatus())
                .igvRate(p.getIgvRate())
                .igvIncluded(p.getIgvIncluded())
                .igvAmount(p.getIgvAmount())
                ...
                .customerUbigeo(p.getCustomerUbigeo())
                .customerDepartment(p.getCustomerDepartment())
                .customerProvince(p.getCustomerProvince())
                .customerDistrict(p.getCustomerDistrict())
                .paymentType(p.getPaymentType() != null ? p.getPaymentType().name() : null)
                .creditDays(p.getCreditDays())
    ...
    private static ProformaV2Response.Item toItem(ProformaItem it) {
        return ProformaV2Response.Item.builder()
                ...
                .stockAvailable(it.getStockAvailable())
                .build();
    }
}
