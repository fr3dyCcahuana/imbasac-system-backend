    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/customer-addresses/map/**")
                        .hasAnyAuthority("MANAGE_CUSTOMERS", "MANAGE_CUSTOMERS_MAP_VIEW")
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/customer-addresses/geolocation-pending")
                        .hasAnyAuthority("MANAGE_CUSTOMERS", "MANAGE_CUSTOMERS_MAP_VIEW")
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/customer-addresses/geolocation/batch/**")
                        .hasAnyAuthority("MANAGE_CUSTOMERS", "MANAGE_CUSTOMERS_MAP_VIEW")
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/customer-addresses/geolocation/batch")
                        .hasAnyAuthority("MANAGE_CUSTOMERS", "MANAGE_CUSTOMERS_MAP_VIEW")
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/customer-addresses/geolocation/batch/**")
                        .hasAnyAuthority("MANAGE_CUSTOMERS", "MANAGE_CUSTOMERS_MAP_VIEW")
